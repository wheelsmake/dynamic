...
var _App_instances, _App_rootNode, _App_proxy, _App_data, _App_dataDesc, _App_detectInsert;
...
_App_rootNode = new WeakMap(), _App_proxy = new WeakMap(), _App_data = new WeakMap(), _App_dataDesc = new WeakMap(), _App_instances = new WeakSet(), _App_detectInsert = function _App_detectInsert(node) {
    if (node.textContent) {
